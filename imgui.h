...
namespace ImGui
{
    ...
    IMGUI_API void          SamePosition(float offset_from_start_x=0.0f, float offset_from_start_y=0.0f, float spacing_w=-1.0f, float spacing_h=-1.0f);  // call between widgets or groups to layout them horizontally. X position given in window coordinates.
